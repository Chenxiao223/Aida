...
public class RecycleBinAdapter extends BaseQuickAdapter<Collocation, BaseViewHolder> {
    private Context context;

    public RecycleBinAdapter(Context context, int LayoutResId) {
        super(LayoutResId);
    ...
    protected void convert(BaseViewHolder helper, Collocation item) {
        ...
        helper.addOnClickListener(R.id.tv_recovery).addOnClickListener(R.id.tv_delete);
    }
}
